...
cf2py intent(out) :: den, ener, pres, vel, cs
cf2py intent(hide) :: nstep
cf2py integer :: nstep
cf2py real*8 :: time, xpos(nstep)
cf2py real*8 :: eblast,omega_in,xgeom_in
cf2py real*8 :: rho0,vel0,ener0,pres0,cs0,gam0
cf2py real*8 :: den(nstep), ener(nstep), pres(nstep)
cf2py real*8 :: vel(nstep), cs(nstep)
