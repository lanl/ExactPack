...
import exactpack.solvers.cog.cog8 as cog8
#import exactpack.solvers.cog.cog8_timmes as timmes
...
#         sol = timmes.Cog8Timmes(rho0=3.0,beta=2.0,temp0=100.,alpha=-1.,gamma=5./3.,cv=1.e12)
...
#         self.assertAlmostEqual(solrt.density[0],10.801498645123559)
    ...
    def test_density(self):
        ...
        sol = cog8.Cog8(rho0=3.0,beta=2.0,temp0=100.,alpha=-1.,gamma=5./3.,Gamma=6.666666666666667e11)
        r = numpy.array([0.1, 0.2])
        t = 0.6
        solrt = sol(r,t)
    ...
    #     sol = timmes.Cog8Timmes(rho0=3.0,beta=2.0,temp0=100.,alpha=-1.,cv=1.e12,gamma=5./3.)
    #     r = numpy.array([0.1, 0.2])
    #     t = 0.6
    #     solrt = sol(r,t)
    ...
    #     self.assertRaises(ValueError, timmes.Cog8Timmes, geometry=-1) 

    def test_geometry_error(self):
        """Cog8 Problem: Test for valid value of geometry"""

        self.assertRaises(ValueError, cog8.Cog8, geometry=-1) 
