...
import pytest
import numpy as np
from exactpack.solvers.nohblackboxeos.solution_tools.residual_functions import noh_residual, simplified_noh_residual,ZeroDensityError, ZeroDeterminantError
