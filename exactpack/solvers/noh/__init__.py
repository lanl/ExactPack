r""" The Noh problem [Noh]_ is a self-similar adiabatic compression
wave in an ideal gas, and it can be formulated in either spherical,
...
:math:`u(r,t)`, and (iii) the pressure :math:`P(r,t)`, at spatial
...
fidelity with which supersonic flows are tracked [LAUR056865]_ .

The analytic solution is particularly simple, taking the closed form given by
[Gehmeyr]_ (typos in the paper corrected). Given a uniform inward radial 
...
.. math::
   ...
   r_\mathrm{shock} = \frac{1}{2}\,(\gamma - 1) \, u_0 \, t ~~~~ \mathrm{where}~~ u_0 > 0\ ,
...
ahead of the shock.  The geometry factor :math:`k=1, 2, 3` corresponds to planar,
...
.. [LAUR056865] Francis X. Timmes, Galen Gisler, and George Hrbek,
   ...
   uniform and adaptive grids for Code Project A.  Los Alamos Report,
   `LA-UR-05-6865 <http://cococubed.asu.edu/papers/la-ur-05-6865.pdf>`_
   (2005)

.. [Gehmeyr] M. Gehmeyr, B. Cheng, and D. Mihalas, Noh's
   constant-velocity shock problem revisited.  Shock Waves **7** 255
   (1997)
