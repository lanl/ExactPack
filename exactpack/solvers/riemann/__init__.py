r"""This problem is related to the one-dimensional Cartesian Riemann
problem for an inviscid, non-heat conducting polytropic gas.

The independent fluid variables are (i) the gas density
