...
code was based. The Kamm code also provides output in dimensionless self similar
variables :math:`\lambda`, :math:`V`, :math:`f`, :math:`g`, :math:`h`. To access
the selfsimilar variables: solver = Sedov() followed by solution =
...
chosen for the default, as it has better behavior in certain asymptotic regimes.
