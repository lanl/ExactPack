...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# title_str = r'Riemann Problem 1 modified: Sod w/ $\gamma_L \neq \gamma_R$ using the IGEOS solver' 
# plt.title(title_str)
# plt.legend()
# plt.show()
# 
...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# title_str = r'Riemann Problem 1 modified reversed: Sod w/ $\gamma_L \neq \gamma_R$ using the IGEOS solver' 
# plt.title(title_str)
# plt.legend()
# plt.show()
# 
...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# plt.title('Riemann Problem for Lee JWL using the GenEOS solver')
# plt.legend()
# plt.show()
# 
# 
...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# plt.title('Riemann Problem for Lee JWL, reversed using the GenEOS solver')
# plt.legend()
# plt.show()
# 
# 
...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# plt.title('Riemann Problem for Shyue JWL using the GenEOS solver')
# plt.legend()
# plt.show()
# 
# 
...
# plt.ylabel(r'Flow Property')
# plt.grid(which='major', axis='both')
# plt.title('Riemann Problem for Shyue JWL, reversed using the GenEOS solver')
# plt.legend()
# plt.show()
# 
# 
