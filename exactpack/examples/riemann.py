...
# 
# fig = plt.figure(figsize=(10,7))
# riem1_gen_soln._streakplot(soln=riem1_gen_result, xs=xvec, t=t_final, N=21, var_str='pressure')
# fig = plt.figure(figsize=(10,7))
# riem1_gen_soln._streakplot(soln=riem1_gen_result, xs=xvec, t=t_final, N=21, var_str='density')
# fig = plt.figure(figsize=(10,7))
# riem1_gen_soln._streakplot(soln=riem1_gen_result, xs=xvec, t=t_final, N=21, var_str='velocity')
# fig = plt.figure(figsize=(10,7))
# riem1_gen_soln._streakplot(soln=riem1_gen_result, xs=xvec, t=t_final, N=21, var_str='specific_internal_energy')
# 
# 
# fig = plt.figure(figsize=(10,7))
